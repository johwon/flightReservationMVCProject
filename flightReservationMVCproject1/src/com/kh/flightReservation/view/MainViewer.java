...
public class MainViewer {
	...
	public static void airLineMenuView() {
		...
		System.out.println("1. 항공사 조회하기 2. 항공사 등록하기 3. 항공사 수정하기 4. 항공사 삭제하기 5. 항공사 정보 조회하기 6. 메인 메뉴로 돌아가기");
		System.out.print("번호를 선택하세요>>");
	}
	...
	public static void reservationMenuView() {
		...
		System.out.println("1. 예약된 항공권 조회하기 2. 항공권 예약하기 3. 예약된 항공권 수정하기 4. 예약된 항공권 취소하기 5. 항공권 상세보기 6. 메인 메뉴로 돌아가기");
		System.out.print("번호를 선택하세요>>");
	}
